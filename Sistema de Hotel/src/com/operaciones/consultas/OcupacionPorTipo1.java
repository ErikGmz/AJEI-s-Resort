...
//---Clase pública---//.
public class OcupacionPorTipo1 extends javax.swing.JFrame {

    //---Constructor---//.
    public OcupacionPorTipo1() {
        initComponents();
        this.setLocationRelativeTo(this);
        
        //Cargar el JInternalFrame.
        OcupacionPorTipo ocupacion = new OcupacionPorTipo();
        this.jDesktopPaneAltas.add(ocupacion);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OcupacionPorTipo1().setVisible(true);
            }
        });
    }
