...
//---Clase pública---//.
public class TotalDeHabitaciones1 extends javax.swing.JFrame {

    //---Constructor---//.
    public TotalDeHabitaciones1() {
        initComponents();
        this.setLocationRelativeTo(this);
        
        //Cargar el JInternalFrame.
        TotalDeHabitaciones total = new TotalDeHabitaciones();
        this.jDesktopPaneAltas.add(total);
        total.setVisible(true);
        
        //Ajustar el tamaño del JInternalFrame.
        try {
            total.setMaximum(true);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TotalDeHabitaciones1().setVisible(true);
            }
        });
    }
